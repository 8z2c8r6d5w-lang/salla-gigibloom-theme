 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const t=globalThis,i$1=t=>t,s$1=t.trustedTypes,e=s$1?s$1.createPolicy("lit-html",{createHTML:t=>t}):void 0,h$2="$lit$",o$1=`lit$${Math.random().toFixed(9).slice(2)}$`,n$1="?"+o$1,r=`<${n$1}>`,l=document,c$1=()=>l.createComment(""),a=t=>null===t||"object"!=typeof t&&"function"!=typeof t,u=Array.isArray,d$2=t=>u(t)||"function"==typeof t?.[Symbol.iterator],f$1="[ \t\n\f\r]",v$2=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,_$2=/-->/g,m=/>/g,p$1=RegExp(`>|${f$1}(?:([^\\s"'>=/]+)(${f$1}*=${f$1}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),g$1=/'/g,$$1=/"/g,y=/^(?:script|style|textarea|title)$/i,x$2=t=>(i,...s)=>({_$litType$:t,strings:i,values:s}),b$1=x$2(1),E$1=Symbol.for("lit-noChange"),A$2=Symbol.for("lit-nothing"),C$1=new WeakMap,P$2=l.createTreeWalker(l,129);function V$2(t,i){if(!u(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==e?e.createHTML(i):i}const N$1=(t,i)=>{const s=t.length-1,e=[];let n,l=2===i?"<svg>":3===i?"<math>":"",c=v$2;for(let i=0;i<s;i++){const s=t[i];let a,u,d=-1,f=0;for(;f<s.length&&(c.lastIndex=f,u=c.exec(s),null!==u);)f=c.lastIndex,c===v$2?"!--"===u[1]?c=_$2:void 0!==u[1]?c=m:void 0!==u[2]?(y.test(u[2])&&(n=RegExp("</"+u[2],"g")),c=p$1):void 0!==u[3]&&(c=p$1):c===p$1?">"===u[0]?(c=n??v$2,d=-1):void 0===u[1]?d=-2:(d=c.lastIndex-u[2].length,a=u[1],c=void 0===u[3]?p$1:'"'===u[3]?$$1:g$1):c===$$1||c===g$1?c=p$1:c===_$2||c===m?c=v$2:(c=p$1,n=void 0);const x=c===p$1&&t[i+1].startsWith("/>")?" ":"";l+=c===v$2?s+r:d>=0?(e.push(a),s.slice(0,d)+h$2+s.slice(d)+o$1+x):s+o$1+(-2===d?i:x);}return [V$2(t,l+(t[s]||"<?>")+(2===i?"</svg>":3===i?"</math>":"")),e]};let S$1 = class S{constructor({strings:t,_$litType$:i},e){let r;this.parts=[];let l=0,a=0;const u=t.length-1,d=this.parts,[f,v]=N$1(t,i);if(this.el=S.createElement(f,e),P$2.currentNode=this.el.content,2===i||3===i){const t=this.el.content.firstChild;t.replaceWith(...t.childNodes);}for(;null!==(r=P$2.nextNode())&&d.length<u;){if(1===r.nodeType){if(r.hasAttributes())for(const t of r.getAttributeNames())if(t.endsWith(h$2)){const i=v[a++],s=r.getAttribute(t).split(o$1),e=/([.?@])?(.*)/.exec(i);d.push({type:1,index:l,name:e[2],strings:s,ctor:"."===e[1]?I$2:"?"===e[1]?L$2:"@"===e[1]?z$2:H$1}),r.removeAttribute(t);}else t.startsWith(o$1)&&(d.push({type:6,index:l}),r.removeAttribute(t));if(y.test(r.tagName)){const t=r.textContent.split(o$1),i=t.length-1;if(i>0){r.textContent=s$1?s$1.emptyScript:"";for(let s=0;s<i;s++)r.append(t[s],c$1()),P$2.nextNode(),d.push({type:2,index:++l});r.append(t[i],c$1());}}}else if(8===r.nodeType)if(r.data===n$1)d.push({type:2,index:l});else {let t=-1;for(;-1!==(t=r.data.indexOf(o$1,t+1));)d.push({type:7,index:l}),t+=o$1.length-1;}l++;}}static createElement(t,i){const s=l.createElement("template");return s.innerHTML=t,s}};function M$1(t,i,s=t,e){if(i===E$1)return i;let h=void 0!==e?s._$Co?.[e]:s._$Cl;const o=a(i)?void 0:i._$litDirective$;return h?.constructor!==o&&(h?._$AO?.(false),void 0===o?h=void 0:(h=new o(t),h._$AT(t,s,e)),void 0!==e?(s._$Co??=[])[e]=h:s._$Cl=h),void 0!==h&&(i=M$1(t,h._$AS(t,i.values),h,e)),i}let R$2 = class R{constructor(t,i){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=i;}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:i},parts:s}=this._$AD,e=(t?.creationScope??l).importNode(i,true);P$2.currentNode=e;let h=P$2.nextNode(),o=0,n=0,r=s[0];for(;void 0!==r;){if(o===r.index){let i;2===r.type?i=new k$1(h,h.nextSibling,this,t):1===r.type?i=new r.ctor(h,r.name,r.strings,this,t):6===r.type&&(i=new Z$2(h,this,t)),this._$AV.push(i),r=s[++n];}o!==r?.index&&(h=P$2.nextNode(),o++);}return P$2.currentNode=l,e}p(t){let i=0;for(const s of this._$AV) void 0!==s&&(void 0!==s.strings?(s._$AI(t,s,i),i+=s.strings.length-2):s._$AI(t[i])),i++;}};let k$1 = class k{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,i,s,e){this.type=2,this._$AH=A$2,this._$AN=void 0,this._$AA=t,this._$AB=i,this._$AM=s,this.options=e,this._$Cv=e?.isConnected??true;}get parentNode(){let t=this._$AA.parentNode;const i=this._$AM;return void 0!==i&&11===t?.nodeType&&(t=i.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,i=this){t=M$1(this,t,i),a(t)?t===A$2||null==t||""===t?(this._$AH!==A$2&&this._$AR(),this._$AH=A$2):t!==this._$AH&&t!==E$1&&this._(t):void 0!==t._$litType$?this.$(t):void 0!==t.nodeType?this.T(t):d$2(t)?this.k(t):this._(t);}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t));}_(t){this._$AH!==A$2&&a(this._$AH)?this._$AA.nextSibling.data=t:this.T(l.createTextNode(t)),this._$AH=t;}$(t){const{values:i,_$litType$:s}=t,e="number"==typeof s?this._$AC(t):(void 0===s.el&&(s.el=S$1.createElement(V$2(s.h,s.h[0]),this.options)),s);if(this._$AH?._$AD===e)this._$AH.p(i);else {const t=new R$2(e,this),s=t.u(this.options);t.p(i),this.T(s),this._$AH=t;}}_$AC(t){let i=C$1.get(t.strings);return void 0===i&&C$1.set(t.strings,i=new S$1(t)),i}k(t){u(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,e=0;for(const h of t)e===i.length?i.push(s=new k(this.O(c$1()),this.O(c$1()),this,this.options)):s=i[e],s._$AI(h),e++;e<i.length&&(this._$AR(s&&s._$AB.nextSibling,e),i.length=e);}_$AR(t=this._$AA.nextSibling,s){for(this._$AP?.(false,true,s);t!==this._$AB;){const s=i$1(t).nextSibling;i$1(t).remove(),t=s;}}setConnected(t){ void 0===this._$AM&&(this._$Cv=t,this._$AP?.(t));}};let H$1 = class H{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,i,s,e,h){this.type=1,this._$AH=A$2,this._$AN=void 0,this.element=t,this.name=i,this._$AM=e,this.options=h,s.length>2||""!==s[0]||""!==s[1]?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=A$2;}_$AI(t,i=this,s,e){const h=this.strings;let o=false;if(void 0===h)t=M$1(this,t,i,0),o=!a(t)||t!==this._$AH&&t!==E$1,o&&(this._$AH=t);else {const e=t;let n,r;for(t=h[0],n=0;n<h.length-1;n++)r=M$1(this,e[s+n],i,n),r===E$1&&(r=this._$AH[n]),o||=!a(r)||r!==this._$AH[n],r===A$2?t=A$2:t!==A$2&&(t+=(r??"")+h[n+1]),this._$AH[n]=r;}o&&!e&&this.j(t);}j(t){t===A$2?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"");}};let I$2 = class I extends H$1{constructor(){super(...arguments),this.type=3;}j(t){this.element[this.name]=t===A$2?void 0:t;}};let L$2 = class L extends H$1{constructor(){super(...arguments),this.type=4;}j(t){this.element.toggleAttribute(this.name,!!t&&t!==A$2);}};let z$2 = class z extends H$1{constructor(t,i,s,e,h){super(t,i,s,e,h),this.type=5;}_$AI(t,i=this){if((t=M$1(this,t,i,0)??A$2)===E$1)return;const s=this._$AH,e=t===A$2&&s!==A$2||t.capture!==s.capture||t.once!==s.once||t.passive!==s.passive,h=t!==A$2&&(s===A$2||e);e&&this.element.removeEventListener(this.name,this,s),h&&this.element.addEventListener(this.name,this,t),this._$AH=t;}handleEvent(t){"function"==typeof this._$AH?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t);}};let Z$2 = class Z{constructor(t,i,s){this.element=t,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s;}get _$AU(){return this._$AM._$AU}_$AI(t){M$1(this,t);}};const B$2=t.litHtmlPolyfillSupport;B$2?.(S$1,k$1),(t.litHtmlVersions??=[]).push("3.3.2");const D$2=(t,i,s)=>{const e=s?.renderBefore??i;let h=e._$litPart$;if(void 0===h){const t=s?.renderBefore??null;e._$litPart$=h=new k$1(i.insertBefore(c$1(),t),t,void 0,s??{});}return h._$AI(t),h};
...
const { is: ye, defineProperty: $e, getOwnPropertyDescriptor: Ae, getOwnPropertyNames: we, getOwnPropertySymbols: _e, getPrototypeOf: xe } = Object, M = globalThis, X$1 = M.trustedTypes, Se = X$1 ? X$1.emptyScript : "", Ee = M.reactiveElementPolyfillSupport, T$1 = (t, e) => t, V$1 = { toAttribute(t, e) {
  switch (e) {
    case Boolean:
      t = t ? Se : null;
      break;
...
E.elementStyles = [], E.shadowRootOptions = { mode: "open" }, E[T$1("elementProperties")] = /* @__PURE__ */ new Map(), E[T$1("finalized")] = /* @__PURE__ */ new Map(), Ee?.({ ReactiveElement: E }), (M.reactiveElementVersions ??= []).push("2.1.2");
const K$1 = globalThis, ee$1 = (t) => t, D$1 = K$1.trustedTypes, te = D$1 ? D$1.createPolicy("lit-html", { createHTML: (t) => t }) : void 0, he = "$lit$", A$1 = `lit$${Math.random().toFixed(9).slice(2)}$`, ce = "?" + A$1, ke = `<${ce}>`, S = document, R$1 = () => S.createComment(""), I$1 = (t) => t === null || typeof t != "object" && typeof t != "function", Y$1 = Array.isArray, Pe = (t) => Y$1(t) || typeof t?.[Symbol.iterator] == "function", L$1 = `[ 	
\f\r]`, P$1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, ie = /-->/g, re = />/g, w = RegExp(`>|${L$1}(?:([^\\s"'>=/]+)(${L$1}*=${L$1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), se = /'/g, oe = /"/g, pe = /^(?:script|style|textarea|title)$/i, Te = (t) => (e, ...i) => ({ _$litType$: t, strings: e, values: i }), g = Te(1), v$1 = /* @__PURE__ */ Symbol.for("lit-noChange"), f = /* @__PURE__ */ Symbol.for("lit-nothing"), ae = /* @__PURE__ */ new WeakMap(), x$1 = S.createTreeWalker(S, 129);
function ue(t, e) {
...
const Ce = (t, e) => {
  ...
  for (let n = 0; n < i; n++) {
    const l = t[n];
    let m, c, u = -1, y = 0;
    for (; y < l.length && (a.lastIndex = y, c = a.exec(l), c !== null); ) y = a.lastIndex, a === P$1 ? c[1] === "!--" ? a = ie : c[1] !== void 0 ? a = re : c[2] !== void 0 ? (pe.test(c[2]) && (s = RegExp("</" + c[2], "g")), a = w) : c[3] !== void 0 && (a = w) : a === w ? c[0] === ">" ? (a = s ?? P$1, u = -1) : c[1] === void 0 ? u = -2 : (u = a.lastIndex - c[2].length, m = c[1], a = c[3] === void 0 ? w : c[3] === '"' ? oe : se) : a === oe || a === se ? a = w : a === ie || a === re ? a = P$1 : (a = w, s = void 0);
...
function k(t, e, i = t, r) {
  ...
  return s?.constructor !== o && (s?._$AO?.(false), o === void 0 ? s = void 0 : (s = new o(t), s._$AT(t, i, r)), r !== void 0 ? (i._$Co ??= [])[r] = s : i._$Cl = s), s !== void 0 && (e = k(t, s._$AS(t, e.values), s, r)), e;
}
class Re {
  constructor(e, i) {
  ...
  u(e) {
    const { el: { content: i }, parts: r } = this._$AD, s = (e?.creationScope ?? S).importNode(i, true);
    x$1.currentNode = s;
...
let z$1 = class z {
  ...
  constructor(e, i, r, s) {
    this.type = 2, this._$AH = f, this._$AN = void 0, this._$AA = e, this._$AB = i, this._$AM = r, this.options = s, this._$Cv = s?.isConnected ?? true;
  }
  get parentNode() {
  ...
  _$AI(e, i = this) {
    e = k(this, e, i), I$1(e) ? e === f || e == null || e === "" ? (this._$AH !== f && this._$AR(), this._$AH = f) : e !== this._$AH && e !== v$1 && this._(e) : e._$litType$ !== void 0 ? this.$(e) : e.nodeType !== void 0 ? this.T(e) : Pe(e) ? this.k(e) : this._(e);
  }
  O(e) {
  ...
  _(e) {
    this._$AH !== f && I$1(this._$AH) ? this._$AA.nextSibling.data = e : this.T(S.createTextNode(e)), this._$AH = e;
  }
  $(e) {
...
let B$1 = class B {
  ...
  _$AI(e, i = this, r, s) {
    ...
    let a = false;
    if (o === void 0) e = k(this, e, i, 0), a = !I$1(e) || e !== this._$AH && e !== v$1, a && (this._$AH = e);
    else {
      const n = e;
      let l, m;
      for (e = o[0], l = 0; l < o.length - 1; l++) m = k(this, n[r + l], i, l), m === v$1 && (m = this._$AH[l]), a ||= !I$1(m) || m !== this._$AH[l], m === f ? e = f : e !== f && (e += (m ?? "") + o[l + 1]), this._$AH[l] = m;
    }
    a && !s && this.j(e);
  }
  j(e) {
...
class ze extends B$1 {
  ...
  _$AI(e, i = this) {
    if ((e = k(this, e, i, 0) ?? f) === v$1) return;
...
C._$litElement$ = true, C.finalized = true, G$1.litElementHydrateSupport?.({ LitElement: C });
...
function ee(t, e, o) {
  ...
  o && o.length > 0 ? i.libraries = o : Array.isArray(i.libraries) && (i.libraries = i.libraries), !e && !i.v && (e = "quarterly"), i.loading || (i.loading = "async"), i.callback = "googleMapsInitCallback";
...
exports.GMapMap = class l extends i {
  constructor() {
    ...
    return b$1`
      <div class="map-page-wrapper">
        ${this.enableAutocomplete ? b$1`
              <div class="auto-complete-map-wrapper">
                <div class="auto-complete-map-box" dir="${t}">
                  ...
                  ></salla-address-autocomplete>
                  ${this.autocompleteHint ? b$1`<span class="hint-wrapper">${this.autocompleteHint}</span>` : ""}
                </div>
              </div>
            ` : ""}
        ...
        <div class="map-container">
          ...
          ${this.enableGeolocation ? b$1`
                <div class="controls-overlay">
                  ...
                  >
                    ...
                    ${this.buttonLabel && this.buttonLabel.trim() ? b$1`<span class="label">${this.buttonLabel}</span>` : ""}
                  </button>
                </div>
              ` : ""}

          ${this.showLoadingOverlay && !this.geolocationError ? b$1`
          ...
          ${this.geolocationError && !this.showLoadingOverlay ? b$1`
...
c([
  n({ type: Object })
], exports.GMapMap.prototype, "center", 2);
c([
  n({ type: Number })
], exports.GMapMap.prototype, "zoom", 2);
c([
  n({ type: String, attribute: "map-id" })
], exports.GMapMap.prototype, "mapId", 2);
c([
  n({ type: String, attribute: "map-type-id" })
], exports.GMapMap.prototype, "mapTypeId", 2);
c([
  n({ type: Number })
], exports.GMapMap.prototype, "heading", 2);
c([
  n({ type: Number })
], exports.GMapMap.prototype, "tilt", 2);
c([
  n({ type: Object })
], exports.GMapMap.prototype, "bounds", 2);
c([
  n({ type: String })
], exports.GMapMap.prototype, "gestureHandling", 2);
c([
  n({ type: Number })
], exports.GMapMap.prototype, "minZoom", 2);
c([
  n({ type: Number })
], exports.GMapMap.prototype, "maxZoom", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "disableDefaultUI", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "zoomControl", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "mapTypeControl", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "scaleControl", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "streetViewControl", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "rotateControl", 2);
c([
  n({ type: Boolean })
], exports.GMapMap.prototype, "fullscreenControl", 2);
c([
  n({ type: Boolean, attribute: "enable-geolocation" })
], exports.GMapMap.prototype, "enableGeolocation", 2);
c([
  n({ type: Boolean, attribute: "show-location-marker" })
], exports.GMapMap.prototype, "showLocationMarker", 2);
c([
  n({ type: Object })
], exports.GMapMap.prototype, "geolocationOptions", 2);
c([
  n({ type: Object, attribute: "location-marker-position" })
], exports.GMapMap.prototype, "locationMarkerPosition", 2);
c([
  n({ type: String, attribute: "location-marker-background" })
], exports.GMapMap.prototype, "locationMarkerBackground", 2);
c([
  n({ type: String, attribute: "location-marker-border-color" })
], exports.GMapMap.prototype, "locationMarkerBorderColor", 2);
c([
  n({ type: String, attribute: "location-marker-glyph-color" })
], exports.GMapMap.prototype, "locationMarkerGlyphColor", 2);
c([
  n({ type: Number, attribute: "location-marker-scale" })
], exports.GMapMap.prototype, "locationMarkerScale", 2);
c([
  n({ type: Object, attribute: "location-circle-options" })
], exports.GMapMap.prototype, "locationCircleOptions", 2);
c([
  n({ type: String })
], exports.GMapMap.prototype, "language", 2);
c([
  n({ type: Object })
], exports.GMapMap.prototype, "options", 2);
c([
  n({ type: String, attribute: "geolocation-button-label" })
], exports.GMapMap.prototype, "geolocationButtonLabel", 2);
c([
  n({ type: String, attribute: "geolocation-loading-title" })
], exports.GMapMap.prototype, "geolocationLoadingTitle", 2);
c([
  n({ type: String, attribute: "geolocation-loading-instructions" })
], exports.GMapMap.prototype, "geolocationLoadingInstructions", 2);
c([
  n({ type: String, attribute: "geolocation-error-title" })
], exports.GMapMap.prototype, "geolocationErrorTitle", 2);
c([
  n({ type: String, attribute: "geolocation-error-button-text" })
], exports.GMapMap.prototype, "geolocationErrorButtonText", 2);
c([
  n({ type: String, attribute: "geolocation-error-timer-message" })
], exports.GMapMap.prototype, "geolocationErrorTimerMessage", 2);
c([
  n({ type: String, attribute: "geolocation-click-to-select-message" })
], exports.GMapMap.prototype, "geolocationClickToSelectMessage", 2);
c([
  n({ type: String, attribute: "geolocation-permission-denied-message" })
], exports.GMapMap.prototype, "geolocationPermissionDeniedMessage", 2);
c([
  n({ type: String, attribute: "geolocation-position-unavailable-message" })
], exports.GMapMap.prototype, "geolocationPositionUnavailableMessage", 2);
c([
  n({ type: String, attribute: "geolocation-timeout-message" })
], exports.GMapMap.prototype, "geolocationTimeoutMessage", 2);
c([
  n({ type: String, attribute: "geolocation-general-error-message" })
], exports.GMapMap.prototype, "geolocationGeneralErrorMessage", 2);
c([
  n({ type: Boolean, attribute: "enable-autocomplete" })
], exports.GMapMap.prototype, "enableAutocomplete", 2);
c([
  n({ type: String, attribute: "autocomplete-hint" })
], exports.GMapMap.prototype, "autocompleteHint", 2);
c([
  n({ type: String, attribute: "autocomplete-proxy-url" })
], exports.GMapMap.prototype, "autocompleteProxyUrl", 2);
c([
  n({ type: String, attribute: "autocomplete-auth-token" })
], exports.GMapMap.prototype, "autocompleteAuthToken", 2);
c([
  n({ type: String, attribute: "autocomplete-placeholder" })
], exports.GMapMap.prototype, "autocompletePlaceholder", 2);
c([
  n({ type: String, attribute: "autocomplete-label" })
], exports.GMapMap.prototype, "autocompleteLabel", 2);
c([
  n({ type: String, attribute: "autocomplete-country" })
], exports.GMapMap.prototype, "autocompleteCountry", 2);
c([
  n({ type: Object, attribute: "autocomplete-location-bias" })
], exports.GMapMap.prototype, "autocompleteLocationBias", 2);
c([
  n({ type: Object, attribute: "autocomplete-location-restriction" })
], exports.GMapMap.prototype, "autocompleteLocationRestriction", 2);
c([
  n({ type: String, attribute: "autocomplete-types" })
], exports.GMapMap.prototype, "autocompleteTypes", 2);
c([
  n({ type: String, attribute: "autocomplete-fields" })
], exports.GMapMap.prototype, "autocompleteFields", 2);
c([
  n({ type: Boolean, attribute: "autocomplete-strict-bounds" })
], exports.GMapMap.prototype, "autocompleteStrictBounds", 2);
c([
  n({ type: Boolean, attribute: "autocomplete-resolve" })
], exports.GMapMap.prototype, "autocompleteResolve", 2);
c([
  n({ type: Number, attribute: "autocomplete-debounce-delay" })
], exports.GMapMap.prototype, "autocompleteDebounceDelay", 2);
c([
  n({ type: Number, attribute: "autocomplete-min-chars" })
], exports.GMapMap.prototype, "autocompleteMinChars", 2);
c([
  F(".map")
], exports.GMapMap.prototype, "mapElement", 2);
c([
  F("salla-address-autocomplete")
], exports.GMapMap.prototype, "autocompleteElement", 2);
c([
  h()
], exports.GMapMap.prototype, "geolocationLoading", 2);
c([
  h()
], exports.GMapMap.prototype, "geolocationError", 2);
c([
  h()
], exports.GMapMap.prototype, "showLoadingOverlay", 2);
c([
  h()
], exports.GMapMap.prototype, "buttonState", 2);
exports.GMapMap = c([
  L("gmap-map")
], exports.GMapMap);
...
exports.GMapMarker = class u extends i {
  constructor() {
...
d([
  n({ type: Object })
], exports.GMapMarker.prototype, "position", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "title", 2);
d([
  n({ type: Boolean })
], exports.GMapMarker.prototype, "gmpDraggable", 2);
d([
  n({ type: Boolean })
], exports.GMapMarker.prototype, "gmpClickable", 2);
d([
  n({ type: Number })
], exports.GMapMarker.prototype, "zIndex", 2);
d([
  n({ type: Object })
], exports.GMapMarker.prototype, "content", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "background", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "borderColor", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "glyphColor", 2);
d([
  n({ type: Number })
], exports.GMapMarker.prototype, "scale", 2);
d([
  n({ type: Boolean })
], exports.GMapMarker.prototype, "draggable", 2);
d([
  n({ type: Boolean })
], exports.GMapMarker.prototype, "clickable", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "icon", 2);
d([
  n({ type: String })
], exports.GMapMarker.prototype, "label", 2);
d([
  h()
], exports.GMapMarker.prototype, "marker", 2);
d([
  h()
], exports.GMapMarker.prototype, "map", 2);
exports.GMapMarker = d([
  L("gmap-marker")
], exports.GMapMarker);
...
exports.GMapInfoWindow = class f extends i {
  constructor() {
...
exports.GMapInfoWindow.styles = i$3`
    :host {
      display: contents;
    }
  `;
P([
  n({ type: Boolean })
], exports.GMapInfoWindow.prototype, "opened", 2);
P([
  n({ type: Object })
], exports.GMapInfoWindow.prototype, "position", 2);
P([
  n({ type: Number })
], exports.GMapInfoWindow.prototype, "zIndex", 2);
P([
  n({ type: Object })
], exports.GMapInfoWindow.prototype, "options", 2);
P([
  h()
], exports.GMapInfoWindow.prototype, "infoWindow", 2);
P([
  h()
], exports.GMapInfoWindow.prototype, "map", 2);
P([
  h()
], exports.GMapInfoWindow.prototype, "marker", 2);
exports.GMapInfoWindow = P([
  L("gmap-info-window")
], exports.GMapInfoWindow);
...
exports.GMapPolyline = class M extends i {
  constructor() {
...
z([
  n({ type: Array })
], exports.GMapPolyline.prototype, "path", 2);
z([
  n({ type: Boolean })
], exports.GMapPolyline.prototype, "editable", 2);
z([
  n({ type: Boolean })
], exports.GMapPolyline.prototype, "draggable", 2);
z([
  n({ type: Object })
], exports.GMapPolyline.prototype, "options", 2);
z([
  h()
], exports.GMapPolyline.prototype, "polyline", 2);
z([
  h()
], exports.GMapPolyline.prototype, "map", 2);
exports.GMapPolyline = z([
  L("gmap-polyline")
], exports.GMapPolyline);
...
exports.GMapPolygon = class w extends i {
  constructor() {
...
O([
  n({ type: Array })
], exports.GMapPolygon.prototype, "path", 2);
O([
  n({ type: Array })
], exports.GMapPolygon.prototype, "paths", 2);
O([
  n({ type: Boolean })
], exports.GMapPolygon.prototype, "editable", 2);
O([
  n({ type: Boolean })
], exports.GMapPolygon.prototype, "draggable", 2);
O([
  n({ type: Object })
], exports.GMapPolygon.prototype, "options", 2);
O([
  h()
], exports.GMapPolygon.prototype, "polygon", 2);
O([
  h()
], exports.GMapPolygon.prototype, "map", 2);
exports.GMapPolygon = O([
  L("gmap-polygon")
], exports.GMapPolygon);
...
exports.GMapCircle = class k extends i {
  constructor() {
...
$([
  n({ type: Object })
], exports.GMapCircle.prototype, "center", 2);
$([
  n({ type: Number })
], exports.GMapCircle.prototype, "radius", 2);
$([
  n({ type: Boolean })
], exports.GMapCircle.prototype, "editable", 2);
$([
  n({ type: Boolean })
], exports.GMapCircle.prototype, "draggable", 2);
$([
  n({ type: Object })
], exports.GMapCircle.prototype, "options", 2);
$([
  h()
], exports.GMapCircle.prototype, "circle", 2);
$([
  h()
], exports.GMapCircle.prototype, "map", 2);
exports.GMapCircle = $([
  L("gmap-circle")
], exports.GMapCircle);
...
exports.GMapRectangle = class S extends i {
  constructor() {
    super(...arguments), this.editable = false, this.draggable = false, this.options = {}, this.eventListeners = [];
  }
  async connectedCallback() {
...
I([
  n({ type: Object })
], exports.GMapRectangle.prototype, "bounds", 2);
I([
  n({ type: Boolean })
], exports.GMapRectangle.prototype, "editable", 2);
I([
  n({ type: Boolean })
], exports.GMapRectangle.prototype, "draggable", 2);
I([
  n({ type: Object })
], exports.GMapRectangle.prototype, "options", 2);
I([
  h()
], exports.GMapRectangle.prototype, "rectangle", 2);
I([
  h()
], exports.GMapRectangle.prototype, "map", 2);
exports.GMapRectangle = I([
  L("gmap-rectangle")
], exports.GMapRectangle);
...
exports.GMapCluster = class C extends i {
  constructor() {
...
T([
  n({ type: Number })
], exports.GMapCluster.prototype, "gridSize", 2);
T([
  n({ type: Number })
], exports.GMapCluster.prototype, "maxZoom", 2);
T([
  n({ type: Array })
], exports.GMapCluster.prototype, "styles", 2);
T([
  n({ type: Function })
], exports.GMapCluster.prototype, "calculator", 2);
T([
  h()
], exports.GMapCluster.prototype, "map", 2);
T([
  h()
], exports.GMapCluster.prototype, "markerClusterer", 2);
T([
  h()
], exports.GMapCluster.prototype, "markers", 2);
exports.GMapCluster = T([
  L("gmap-cluster")
], exports.GMapCluster);
...
exports.GMapStreetViewPanorama = class b extends i {
  constructor() {
  ...
  render() {
    return b$1`<div class="panorama"></div>`;
  }
};
exports.GMapStreetViewPanorama.styles = i$3`
    :host {
      display: block;
      position: relative;
      width: 100%;
...
v([
  n({ type: Object })
], exports.GMapStreetViewPanorama.prototype, "position", 2);
v([
  n({ type: String })
], exports.GMapStreetViewPanorama.prototype, "pano", 2);
v([
  n({ type: Number })
], exports.GMapStreetViewPanorama.prototype, "zoom", 2);
v([
  n({ type: Object })
], exports.GMapStreetViewPanorama.prototype, "pov", 2);
v([
  n({ type: Boolean })
], exports.GMapStreetViewPanorama.prototype, "visible", 2);
v([
  n({ type: Boolean })
], exports.GMapStreetViewPanorama.prototype, "motionTracking", 2);
v([
  n({ type: Object })
], exports.GMapStreetViewPanorama.prototype, "options", 2);
v([
  F(".panorama")
], exports.GMapStreetViewPanorama.prototype, "panoramaElement", 2);
v([
  h()
], exports.GMapStreetViewPanorama.prototype, "panorama", 2);
exports.GMapStreetViewPanorama = v([
  L("gmap-street-view-panorama")
], exports.GMapStreetViewPanorama);

exports.bindEvents = _;
exports.cleanupListeners = x;
exports.getTranslations = tt;
exports.importLibrary = st;
exports.isRTL = et;
exports.load = ee;
exports.loaded = D;
exports.updateProperty = B;
