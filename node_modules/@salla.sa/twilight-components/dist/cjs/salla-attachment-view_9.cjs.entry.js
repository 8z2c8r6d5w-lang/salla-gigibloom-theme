...
const sallaBookingFieldCss = "/*!twlt*/:host{display:block}.outline{outline-style:solid}.filter{filter:var(--tw-blur) var(--tw-brightness) var(--tw-contrast) var(--tw-grayscale) var(--tw-hue-rotate) var(--tw-invert) var(--tw-saturate) var(--tw-sepia) var(--tw-drop-shadow)}.s-hidden{display:none}.s-booking-field-main{display:flex;align-items:center;justify-content:space-between;gap:0.75rem}@media (min-width: 640px){.s-booking-field-main{justify-content:flex-end}}.s-booking-field-price{display:flex;align-items:center;gap:0.5rem}.s-booking-field-book-now-content{display:flex;align-items:center;gap:0.5rem}.s-booking-field-book-now-content span svg{height:1rem;width:1rem}.s-booking-field-modal iframe{width:100%;transition-property:height;transition-duration:300ms;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1)}.s-booking-field-modal .s-modal-body{overflow:hidden;padding:1.25rem}.s-booking-field-modal .s-modal-title{display:flex;justify-content:flex-start}.s-booking-field-reservations{margin-top:0.625rem;display:flex;flex-wrap:wrap;align-items:center;gap:0.5rem}.s-booking-field-reservations-item{display:flex;flex-direction:row;align-items:center;justify-content:space-between;border-radius:4px;border-width:1px;--tw-border-opacity:1;border-color:rgb(229 231 235 / var(--tw-border-opacity, 1));padding-left:0.625rem;padding-right:0.625rem;padding-top:0.25rem;padding-bottom:0.25rem;font-size:0.75rem;--tw-text-opacity:1;color:rgb(31 41 55 / var(--tw-text-opacity, 1))}.s-booking-field-reservations-item>span{display:flex;flex-direction:row;align-items:center;justify-content:flex-start}.s-booking-field-reservations-time{unicode-bidi:plaintext}.s-booking-field-reservations-has-time{--tw-border-opacity:1;border-color:rgb(229 231 235 / var(--tw-border-opacity, 1))}.s-booking-field-reservations-has-time:where([dir=\"ltr\"],[dir=\"ltr\"] *){margin-right:1rem;border-right-width:1px;padding-right:1rem}.s-booking-field-reservations-has-time:where([dir=\"rtl\"],[dir=\"rtl\"] *){margin-left:1rem;border-left-width:1px;padding-left:1rem}.s-booking-field-reservations-icon:where([dir=\"ltr\"],[dir=\"ltr\"] *){margin-right:0.5rem}.s-booking-field-reservations-icon:where([dir=\"rtl\"],[dir=\"rtl\"] *){margin-left:0.5rem}.s-booking-field-reservations-icon svg{height:0.75rem;width:0.75rem;fill:#1f2937}";
...
const SallaBookingField = class {
    ...
    render() {
        return (index.h(index.Host, { key: '2ccdcbee3a61bfa69e1e272dca9e993cd568baf8' }, index.h("div", { key: 'b26b71c2d9ac60e84461e54b4979c5e89e87e437', class: "s-booking-field-main" }, this.option.required || this.reservations.length > 0 ? index.h("div", { class: "s-booking-field-price" }, index.h("span", { innerHTML: salla.money(this.option.price) })) : '', index.h("salla-button", { key: '739e1d72691af1760caa732090057b24c751a807', class: "s-booking-field-book-now", size: "small", loaderPosition: "center", fill: "outline", onClick: event => this.openBookingModal(event, false) }, index.h("span", { key: 'c00e5db1bd56c66c2b72db3371c748fa9fa10602', class: "s-booking-field-book-now-content" }, index.h("span", { key: 'd85c983123460c3f528ab6aea7b6c57bb9cb0f0f', innerHTML: BookingTime }), this.reservations.length ? this.editLabel : this.bookNowLabel))), this.reservations.length > 0 && (index.h("div", { key: 'b94321aaad303ab7aa21f629b8c9de458209346b', class: "s-booking-field-reservations" }, this.reservations.map((reservation, index$1) => (index.h("div", { key: index$1, class: "s-booking-field-reservations-item" }, this.renderReservationDate(reservation), this.renderReservationTime(reservation)))))), index.h("input", { key: 'aa18bd55cfd8903cfe66655ed4737854aab6da75', class: "s-hidden", name: this.option.name, required: this.option.required, value: JSON.stringify(this.reservations) === '[]' ? '' : JSON.stringify(this.reservations), ref: reservations => this.reservationsInput = reservations }), this.iframeReady && this.bookingModal()));
    }
    get host() { return index.getElement(this); }
};
SallaBookingField.style = sallaBookingFieldCss;

const sallaColorPickerCss = "/*!twlt*/.resize{resize:both}.s-hidden{display:none}.s-color-picker-main{margin:0.25rem;display:inline-block}.s-color-picker-main .picker_wrapper{margin:0px !important;--tw-shadow:0 0 #0000 !important;--tw-shadow-colored:0 0 #0000 !important;box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow) !important}.s-color-picker-main .picker_arrow{display:none}.s-color-picker-widget{display:flex;width:auto;width:fit-content;align-items:center;justify-content:space-between;border-radius:var(--s-radius, 0.25rem);border-width:1px;--tw-border-opacity:1;border-color:rgb(209 213 219 / var(--tw-border-opacity, 1));--tw-bg-opacity:1;background-color:rgb(255 255 255 / var(--tw-bg-opacity, 1));padding:0.25rem}.s-color-picker-widget svg{height:1.25rem;width:1.25rem;transition-property:transform;transition-timing-function:cubic-bezier(0.4, 0, 0.2, 1);transition-duration:200ms}.s-color-picker-widget span{font-size:1.125rem;line-height:1.75rem}.s-color-picker-widget-canvas{height:2rem;width:2rem}";
...
const SallaColorPicker = class {
    ...
    initColorPicker() {
        this.pickerReady = Promise.resolve().then(function () { return require('./vanilla-picker-C6XEDo7R.js'); }).then(function (n) { return n.vanillaPicker; }).then(mod => {
    ...
    render() {
        return (index.h(index.Host, { key: 'b0ddc9c457300b40e5e64a54aa13e38f46106dd8', class: "s-color-picker-main" }, index.h("slot", { key: '409622ef888a6fda18a44406b28bdb1a37abced7', name: "widget" }, index.h("div", { key: '53f2a7135429a3aea05efc69bb66b4dde470b8e0', class: "s-color-picker-widget" }, index.h("div", { key: '715cdf2d6a310f7d2add7f155a6db932a2e670c8', class: "s-color-picker-widget-canvas", ref: dv => (this.canvas = dv) }), index.h("span", { key: '95ea57b71b1352c1d3801efcf60475d17157056a', innerHTML: keyboard_arrow_down.ArrowDown }))), index.h("input", { key: 'e25c80f98c10d9006d16c28af9d799896a1b5e07', class: "s-hidden", name: this.name, required: this.required, value: this.color, ref: color => (this.colorInput = color) })));
    }
    componentDidLoad() {
        if (this.canvas)
...
const SallaDatetimePicker = class {
    ...
    async loadFlatpickr() {
        ...
        try {
            ...
            if (this.locale && this.locale !== 'en') {
                try {
                    await (function (t) { return Promise.resolve().then(function () { return /*#__PURE__*/_interopNamespace(require(t)); }); })(`flatpickr/dist/l10n/${this.locale}.js`);
                }
                catch (e) {
    ...
    render() {
        return index.h("div", { key: '64b648c87a1395cc19db863b2ce0cfbabf647561', class: "s-datetime-picker" }, index.h("input", { key: '87bfdfff27591a2ad83a4edad089420701f11452', type: "datetime", name: this.name, value: this.value, required: this.required, disabled: this.disabled, placeholder: this.placeholder, class: "s-datetime-picker-input", ref: (el) => this.dateInput = el }));
    }
...
const SallaFileUpload = class {
    ...
    async loadFilePond() {
        ...
        try {
            const [FilePondModule, FilePondPluginFileValidateSize, FilePondPluginImageExifOrientation, FilePondPluginImagePreview, FilePondPluginImageEdit, FilePondPluginFileValidateType, FilePondPluginFilePoster] = await Promise.all([
                Promise.resolve().then(function () { return require('./filepond-CZU58LOM.js'); }).then(function (n) { return n.filepond; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-file-validate-size-DFRAkigk.js'); }).then(function (n) { return n.filepondPluginFileValidateSize; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-image-exif-orientation-DrxZo3Jn.js'); }).then(function (n) { return n.filepondPluginImageExifOrientation; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-image-preview-B74gwSzv.js'); }).then(function (n) { return n.filepondPluginImagePreview; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-image-edit-CRJzlmon.js'); }).then(function (n) { return n.filepondPluginImageEdit; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-file-validate-type-ZTl-QvJh.js'); }).then(function (n) { return n.filepondPluginFileValidateType; }),
                Promise.resolve().then(function () { return require('./filepond-plugin-file-poster-Bx6NNe0J.js'); }).then(function (n) { return n.filepondPluginFilePoster; })
            ]);
    ...
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.added = index.createEvent(this, "added");
        this.invalidInput = index.createEvent(this, "invalidInput");
    ...
    render() {
        return (index.h(index.Host, { key: '851d41cc6012f516488a99f56f9937c14f79bc85', class: {
                "s-file-upload": true,
...
const SallaQuantityInput = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: '97cfd53bacd63cfd819d733f25055fd6befcb46a', class: "s-quantity-input" }, index.h("div", { key: 'fbe95d268cfb58eac1cf751d39695fb1abb76de1', class: "s-quantity-input-container" }, index.h("button", { key: '511ee9299a053f3853b1e68783ec345523bf3dc2', onClick: () => this.increase(), class: "s-quantity-input-increase-button s-quantity-input-button", type: "button", "aria-label": salla.lang.getWithDefault('common.elements.increase_quantity', 'Increase quantity') }, !this.hasIncrementSlot ? index.h("span", { innerHTML: minus.plusIcon }) : '', index.h("slot", { key: '104cad1ffb95e0213ee1ce3e215213d1ad346bdc', name: "increment-button" })), index.h("input", { key: '60d3114d8d7ca3a4923761041b4b02218fc903ce', class: "s-quantity-input-input", ...inputAttributes, ref: (el) => this.textInput = el, onInput: (event) => this.setValue(event.target.value), inputMode: "numeric", pattern: "[0-9]*", min: "1", readOnly: this.disableInput, value: this.quantity }), index.h("button", { key: '554b02f7b85cbd026431adf2573efa1cbb0564bb', class: "s-quantity-input-decrease-button s-quantity-input-button", onClick: () => this.decrease(), type: "button", "aria-label": salla.lang.getWithDefault('common.elements.decrease_quantity', 'Decrease quantity') }, !this.hasDecrementSlot ? index.h("span", { innerHTML: minus.minusIcon }) : '', index.h("slot", { key: '8028a32c8c83a4205e093e8ad5ccf5d8e9fd019b', name: "decrement-button" })))));
    }
    get host() { return index.getElement(this); }
...
const SallaTelInput = class {
    ...
    async loadTelInput() {
        if (this.TelInput)
            return;
        try {
            const telInputModule = await Promise.resolve().then(function () { return require('./intlTelInput-uMQIP2ZD.js'); }).then(function (n) { return n.intlTelInput; });
    ...
    constructor(hostRef) {
        index.registerInstance(this, hostRef);
        this.phoneEntered = index.createEvent(this, "phoneEntered");
        /**
         * input name
         */
        this.name = 'phone';
    ...
    // Init is async and v26 loads the validation utils lazily; both must settle.
    async whenReady() {
        await this.initPromise;
        await this.utilsReady;
    }
    /**
     * Get current values
    ...
    async isValid() {
        ...
        this.errorMsg.innerText = this.errorMap[errorCode] || this.invalidNumber || '';
    ...
    async initTelInput() {
        ...
        this.iti = this.TelInput(this.phoneInput, {
            ...
            countryOrder: ['sa', 'ae', 'kw', 'bh', 'qa', 'iq', 'om', 'ye', 'eg', 'jo', 'ps', 'sd', 'lb', 'dz', 'tn', 'ma', 'ly'],
            excludeCountries: ['sy', 'ir', 'cu', 'kp'],
            formatOnDisplay: false,
            separateDialCode: true,
            autoPlaceholder: 'aggressive',
            // v26 adds a country-search box to the dropdown by default. Keep it off to
            // preserve the previous (v18) dropdown UX and avoid shipping an unstyled input.
            countrySearch: false,
            // v26 dropped the `utilsScript` URL option in favour of `loadUtils`. We load the
            // utils bundled with the installed package as a lazy chunk (no CDN, version-locked),
            // which carries the up-to-date libphonenumber metadata (e.g. Oman 7[3-5] mobiles).
            loadUtils: () => Promise.resolve().then(function () { return require('./utils-BD1un9WN.js'); }),
            dropdownContainer: this.host
        });
        // Rejects if the lazy utils chunk fails; swallow so validation still runs.
        this.utilsReady = this.iti.promise.catch(() => { });
    ...
    render() {
        return (index.h(index.Host, { key: '47ef84c73844f5a999e8894f4f5111daf47af248', class: "s-tel-input" }, index.h("input", { key: '2a1a3ce9b9343017a74de61781d3efa9054fdbfb', type: "tel", disabled: this.disabled, name: this.name, value: this.phone, onChange: (event) => this.handleCountryInput(event), ref: el => this.phoneInput = el, enterkeyhint: "next", autocomplete: "tel", class: "s-tel-input-control tel-input s-ltr" }), index.h("span", { key: '48ff6f38f9dd8c234f1ebfee4f1ded3cf7d87048', class: "s-tel-input-error-msg", ref: el => this.errorMsg = el }), index.h("input", { key: '2421046f60a795bdb56d29078ba36e8fb9ee0511', type: "hidden", name: "country_code", value: this.countryCode, ref: el => this.countryCodeInput = el, class: "country_code" })));
    }
    componentDidLoad() {
        this.initPromise = this.initTelInput();
