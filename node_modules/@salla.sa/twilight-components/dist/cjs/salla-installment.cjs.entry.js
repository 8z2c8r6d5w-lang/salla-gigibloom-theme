    ...
    render() {
        ...
        return (index.h(index.Host, null, this.tamaraIsActive &&
            ...
            (this.mispayActive.publicKey ? (index.h("div", { class: "mb-5" }, index.h("mispay-widget", { amount: this.price, lang: this.language }))) : (index.h("div", { class: "s-installment-mispay-wrapper" }, index.h("div", { class: "s-installment-mispay-content" }, index.h("img", { src: salla.url.cdn('images/payment/png/mispay.png'), alt: "mispay" }), index.h("span", { class: "s-installment-mispay-content-text", innerHTML: this.installment_sheria_text('pages.products.installments', {
                    ...
                    installments: 4,
                }) }))))), this.emkanIsActive && this.currency === "SAR" ? (index.h("div", { class: "s-installment-emkan-wrapper" }, index.h("div", { class: "s-installment-emkan-content" }, index.h("img", { src: salla.url.assetsCdn('images/payment/png/emkan.png'), alt: "emkan" }), index.h("span", { class: "s-installment-emkan-content-text", innerHTML: this.installment_sheria_text('pages.products.installments_emkan', {
                payment: salla.money(parseFloat(this.price)),
                installments: 5,
            ...
            : '', this.klarnaIsActive && this.klarnaIsActive.locales?.length > 0 && (index.h("div", { class: "s-installment-klarna-wrapper" }, index.h("klarna-placement", { "data-key": this.klarnaIsActive.dataKey || 'credit-promotion-badge', "data-locale": this.getKlarnaLocale(), "data-purchase-amount": String(Math.round(parseFloat(this.price) * 100)) })))));
    }
