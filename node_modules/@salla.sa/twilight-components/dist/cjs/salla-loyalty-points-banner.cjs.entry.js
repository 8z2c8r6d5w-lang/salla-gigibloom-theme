...
const sallaLoyaltyPointsBannerCss = "/*!twlt*/.s-loyalty-points-banner-container{margin-bottom:0.75rem;display:flex;width:100%;align-items:center;gap:0.5rem;border-radius:0.5rem;background-color:rgb(209 180 76 / var(--tw-bg-opacity, 1));--tw-bg-opacity:0.1;padding-left:0.75rem;padding-right:0.75rem;padding-top:0.5rem;padding-bottom:0.5rem}.s-loyalty-points-banner-icon{display:flex;height:2rem;width:2rem;flex-shrink:0;align-items:center;justify-content:center;border-radius:9999px;--tw-bg-opacity:1;background-color:rgb(209 180 76 / var(--tw-bg-opacity, 1))}.s-loyalty-points-banner-label{font-size:0.875rem;line-height:1.25rem;font-weight:700;--tw-text-opacity:1;color:rgb(209 180 76 / var(--tw-text-opacity, 1))}.s-loyalty-points-banner-description{font-size:0.875rem;line-height:1.25rem}";

const SallaLoyaltyPointsBanner = class {
    constructor(hostRef) {
    ...
    render() {
        ...
        return (index.h(index.Host, null, index.h("div", { class: "s-loyalty-points-banner-container" }, index.h("div", { class: "s-loyalty-points-banner-icon" }, index.h("span", { class: "s-loyalty-points-banner-inner-icon", innerHTML: MoneyIcon })), index.h("p", null, index.h("span", { class: "s-loyalty-points-banner-label" }, salla.lang.get('pages.loyalty_program.earn'), ' '), index.h("span", { class: "s-loyalty-points-banner-label" }, `+${this.pointsData.points}`, " "), index.h("span", { class: "s-loyalty-points-banner-label" }, salla.lang.get('pages.loyalty_program.loyalty_point'), ' '), index.h("span", { class: "s-loyalty-points-banner-description" }, salla.lang.get('pages.loyalty_program.on_order_total_when_purchase'))))));
    }
    get host() { return index.getElement(this); }
};
SallaLoyaltyPointsBanner.style = sallaLoyaltyPointsBannerCss;

exports.salla_loyalty_points_banner = SallaLoyaltyPointsBanner;
