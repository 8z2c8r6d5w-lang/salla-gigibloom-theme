...
const SallaSocial = class {
    ...
    render() {
        ...
        return (index.h(index.Host, { key: 'a4c05f6fcf54b6d34c547d7b27a61d4afbd91f10' }, index.h("ul", { key: 'ab690b3eba0190d6830a5988510c404dafa4e450', class: "s-social-list" }, linksArray.map((link) => (index.h("li", { class: "s-social-link" }, index.h("div", { id: "social-slot", innerHTML: this.socialSlot
