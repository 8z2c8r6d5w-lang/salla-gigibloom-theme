...
const SallaUserMenu = class {
    constructor(hostRef) {
        ...
        this.items = {
            ...
            wallet: WalletIcon,
            loyalty_points: gift.loyaltyProgramIcon,
            profile: UserCircle
        };
    }
    ...
    getMenuItem([itemKey, itemValue], i) {
        ...
        return (index.h("li", { class: {
            ...
            } }, index.h("a", { ...this.getItemAnchorLinkAttrs(itemKey), class: "s-user-menu-dropdown-item-link", onClick: event => this.menuItemClicked(event, itemKey) }, index.h("i", { class: "s-user-menu-dropdown-item-prefix", innerHTML: itemValue }), index.h("span", { class: "s-user-menu-dropdown-item-title" }, this[itemKey]), itemKey === 'wallet' && !this.inline && (this.walletBalance || this.walletBalanceLoading) ? (index.h("span", { class: "s-user-menu-dropdown-item-balance", style: { display: 'inline-flex', alignItems: 'center', gap: '4px' } }, this.walletBalance ? index.h("span", { innerHTML: this.walletBalance }) : '', this.walletBalanceLoading ? index.h("salla-loading", { size: "14" }) : '')) : (''), !['٠', '0', undefined].includes(this.badges[itemKey]) ? (index.h("span", { class: "s-user-menu-dropdown-item-badge" }, this.badges[itemKey])) : (''))));
    }
