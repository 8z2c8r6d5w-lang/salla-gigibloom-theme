...
export class SallaBookingField {
    ...
    render() {
        return (h(Host, { key: '2ccdcbee3a61bfa69e1e272dca9e993cd568baf8' }, h("div", { key: 'b26b71c2d9ac60e84461e54b4979c5e89e87e437', class: "s-booking-field-main" }, this.option.required || this.reservations.length > 0 ? h("div", { class: "s-booking-field-price" }, h("span", { innerHTML: salla.money(this.option.price) })) : '', h("salla-button", { key: '739e1d72691af1760caa732090057b24c751a807', class: "s-booking-field-book-now", size: "small", loaderPosition: "center", fill: "outline", onClick: event => this.openBookingModal(event, false) }, h("span", { key: 'c00e5db1bd56c66c2b72db3371c748fa9fa10602', class: "s-booking-field-book-now-content" }, h("span", { key: 'd85c983123460c3f528ab6aea7b6c57bb9cb0f0f', innerHTML: BookingTime }), this.reservations.length ? this.editLabel : this.bookNowLabel))), this.reservations.length > 0 && (h("div", { key: 'b94321aaad303ab7aa21f629b8c9de458209346b', class: "s-booking-field-reservations" }, this.reservations.map((reservation, index) => (h("div", { key: index, class: "s-booking-field-reservations-item" }, this.renderReservationDate(reservation), this.renderReservationTime(reservation)))))), h("input", { key: 'aa18bd55cfd8903cfe66655ed4737854aab6da75', class: "s-hidden", name: this.option.name, required: this.option.required, value: JSON.stringify(this.reservations) === '[]' ? '' : JSON.stringify(this.reservations), ref: reservations => this.reservationsInput = reservations }), this.iframeReady && this.bookingModal()));
    }
