...
salla-comment-item .s-comments-flex-1 {
  min-width: 0;
}

.s-comments-item-review-factors-toggle {
  display: inline-flex;
  align-items: center;
  gap: 0.35rem;
  padding: 0;
...
.s-comments-item-review-factors-chevron {
  line-height: 1;
  transform: rotate(180deg);
  transition: transform 0.2s ease;
}

.s-comments-item-review-factors-chevron.is-open {
  transform: rotate(0deg);
}

.s-comments-item-review-factors {
...
.s-comments-item-review-factor-row {
  display: flex;
  align-items: center;
...
.s-comments-item-review-factor-row + .s-comments-item-review-factor-row {
  margin-top: 0.5rem;
}

.s-comments-item-review-factor-label,
.s-comments-item-review-factor-name {
  color: #4b5563;
  font-size: 0.9rem;
  line-height: 1.45;
}
...
.s-comments-item-review-factor-value {
  display: inline-flex;
  align-items: center;
  gap: 0.35rem;
  min-width: 0;
...
.s-comments-count-label:is(.dark *) {
  --tw-text-opacity: 1;
...
.s-comments-item-timestamp:is(.dark *) {
  --tw-text-opacity: 1;
...
.s-comments-item-user-info-name-with-margin:where([dir="ltr"], [dir="ltr"] *) {
  margin-right: 2.5rem;
}
...
.s-comments-item-pinned-icon-with-margin:where([dir="ltr"], [dir="ltr"] *) {
  margin-right: 2.5rem;
  margin-left: 0.5rem;
}
.s-comments-item-pinned-icon-with-margin:where([dir="rtl"], [dir="rtl"] *) {
  margin-left: 2.5rem;
  margin-right: 0.5rem;
}
...
.s-comments-item-content:is(.dark *) {
  --tw-text-opacity: 1;
