...
import { CommentType, buildCommentSortOptions, isFeatureEnabled } from "./interfaces";
...
export class SallaComments {
    ...
    static get originalStyleUrls() {
        return {
            "$": ["salla-comments.scss", "../salla-infinite-scroll/salla-infinite-scroll.scss"]
        };
    }
    static get styleUrls() {
        return {
            "$": ["salla-comments.css", "../salla-infinite-scroll/salla-infinite-scroll.css"]
        };
    }
    static get properties() {
        return {
            ...
            "sort": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "string | CommentSort",
                    "resolved": "string",
                    "references": {
                        "CommentSort": {
                            "location": "import",
                            "path": "./interfaces",
                            "id": "src/components/salla-comments/interfaces.ts::CommentSort"
                        }
                    }
                },
                "required": false,
