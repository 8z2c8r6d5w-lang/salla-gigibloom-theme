    ...
    static get properties() {
        return {
            ...
            "width": {
                ...
                "mutable": false,
                "complexType": {
                    "original": "'xs' | 'sm' | 'md' | 'lg' | 'xl' | 'full' | 'custom'",
                    "resolved": "\"custom\" | \"full\" | \"lg\" | \"md\" | \"sm\" | \"xl\" | \"xs\"",
                    "references": {}
                },
                "required": false,
                "optional": false,
                "docs": {
                    "tags": [],
                    "text": "The size of the modal. Use `custom` along with `customWidth` to set an arbitrary max-width."
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "customWidth": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Custom max-width to apply when `width` is set to `custom`, e.g. `600px` or `40rem`."
                },
                "getter": false,
                "setter": false,
                "reflect": false,
            ...
            "showBack": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Show a back button in the header corner. Defaults to `false`"
                },
                "getter": false,
                "setter": false,
                "reflect": true,
            ...
            "hideCloseButton": {
                ...
                "docs": {
                    "tags": [],
                    "text": "Hide the close (X) button in the modal header, without affecting `isClosable`\n(backdrop click / programmatic close still work). Defaults to `false`"
                },
                "getter": false,
                "setter": false,
                "reflect": false,
