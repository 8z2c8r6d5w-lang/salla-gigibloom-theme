...
export class SallaReviewsSummary {
    ...
    render() {
        ...
        const reviewElements = Object.keys(ratings).reverse().map((rating) => {
            ...
            return (h("div", { key: rating, class: "s-reviews-summary-row" }, h("div", { class: "s-reviews-summary-row-rate" }, rating, " ", h("span", { innerHTML: Star2 })), h("salla-progress-bar", { class: "s-reviews-summary-progress", value: percentage, target: 100, hideUnits: true, height: '20px' }), h("span", { class: "s-reviews-summary-percentage" }, percentage, "%")));
        });
