...
.ltr .iti__selected-country, [dir=ltr] .iti__selected-country {
...
.iti__country .iti__flag, .iti__country-name, .iti__dial-code {
...
.iti--container.iti--fullscreen-popup .iti__country {
  padding: 10px 10px;
  line-height: 1.5em;
}
...
.s-gifting-step-two .s-form-group.s-form-has-error .s-tel-input-control {
  --tw-border-opacity: 1 !important;
  border-color: rgb(255 68 58 / var(--tw-border-opacity, 1)) !important;
}
.s-tel-input-control {
  height: 2.5rem;
  width: 100%;
