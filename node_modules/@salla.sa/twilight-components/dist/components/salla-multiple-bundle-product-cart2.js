...
import { d as defineCustomElement$g } from './salla-accordion2.js';
import { d as defineCustomElement$f } from './salla-accordion-body2.js';
import { d as defineCustomElement$e } from './salla-accordion-head2.js';
...
const SallaMultipleBundleProductCart = /*@__PURE__*/ proxyCustomElement(class SallaMultipleBundleProductCart extends HTMLElement {
    ...
    render() {
        return (h(Host, { key: 'f4a66dc2916ad42108b551790e1a1a581a55d6b1', class: "s-multiple-bundle-product-wrapper" }, h("div", { key: 'fa96a2da58ee5be80c79c1a6fff66fbcf49cd87e', class: "s-multiple-bundle-product-wrapper-sections" }, this.sections.map((section, sectionIndex) => {
