...
const SallaTelInput = /*@__PURE__*/ proxyCustomElement(class SallaTelInput extends HTMLElement {
    ...
    async loadTelInput() {
        if (this.TelInput)
            return;
        try {
            const telInputModule = await import('./intlTelInput.js').then(function (n) { return n.i; });
    ...
    render() {
        return (h(Host, { key: '47ef84c73844f5a999e8894f4f5111daf47af248', class: "s-tel-input" }, h("input", { key: '2a1a3ce9b9343017a74de61781d3efa9054fdbfb', type: "tel", disabled: this.disabled, name: this.name, value: this.phone, onChange: (event) => this.handleCountryInput(event), ref: el => this.phoneInput = el, enterkeyhint: "next", autocomplete: "tel", class: "s-tel-input-control tel-input s-ltr" }), h("span", { key: '48ff6f38f9dd8c234f1ebfee4f1ded3cf7d87048', class: "s-tel-input-error-msg", ref: el => this.errorMsg = el }), h("input", { key: '2421046f60a795bdb56d29078ba36e8fb9ee0511', type: "hidden", name: "country_code", value: this.countryCode, ref: el => this.countryCodeInput = el, class: "country_code" })));
    }
    componentDidLoad() {
