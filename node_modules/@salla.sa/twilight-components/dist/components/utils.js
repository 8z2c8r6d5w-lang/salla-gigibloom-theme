...
F.prototype.m=function(){var a=ya;a||(ya=a=y(F,{0:{name:"NumberFormat",ia:"i18n.phonenumbers.NumberFormat"},1:{name:"pattern",required:true,i:9,type:String},2:{name:"format",required:true,i:9,type:String},3:{name:"leading_digits_pattern",aa:true,i:9,type:String},4:{name:"national_prefix_formatting_rule",i:9,type:String},6:{name:"national_prefix_optional_when_formatting",i:8,defaultValue:false,type:Boolean},5:{name:"domestic_carrier_code_formatting_rule",i:9,type:String}}));return a};F.m=F.prototype.m;
G.prototype.m=function(){var a=za;a||(za=a=y(G,{0:{name:"PhoneNumberDesc",ia:"i18n.phonenumbers.PhoneNumberDesc"},2:{name:"national_number_pattern",i:9,type:String},9:{name:"possible_length",aa:true,i:5,type:Number},10:{name:"possible_length_local_only",aa:true,i:5,type:Number},6:{name:"example_number",i:9,type:String}}));return a};G.m=G.prototype.m;
...
Ta=/^\(?\$1\)?$/;function Ua(a){return 2>a.length?false:N(Ra,a)}function Va(a){return N(Ma,a)?O(a,Ga):O(a,Ea)}function Wa(a){var b=Va(a.toString());E(a);a.g(b);}function Xa(a){return null!=a&&(1!=x(a,9)||-1!=u(a,9)[0])}function O(a,b){for(var c=new D,d,e=a.length,f=0;f<e;++f)d=a.charAt(f),d=b[d.toUpperCase()],null!=d&&c.g(d);return c.toString()}function Ya(a){return 0==a.length||Ta.test(a)}function P(a){return null!=a&&isNaN(a)&&a.toUpperCase()in Da}
...
function Y(a,b,c){if(!P(c)&&0<b.length&&"+"!=b.charAt(0))throw Error("Invalid country calling code");return hb(a,b,c,true)}
function hb(a,b,c,d){if(null==b)throw Error("The string supplied did not seem to be a phone number");if(250<b.length)throw Error("The string supplied is too long to be a phone number");var e=new D;var f=b.indexOf(";phone-context=");if(-1===f)f=null;else if(f+=15,f>=b.length)f="";else {var g=b.indexOf(";",f);f=-1!==g?b.substring(f,g):b.substring(f);}var h=f;null==h?g=true:0===h.length?g=false:(g=Na.exec(h),h=Oa.exec(h),g=null!==g||null!==h);if(!g)throw Error("The string supplied did not seem to be a phone number");
...
function qb(a){var b=a.ba.toString(),c=new RegExp("^(?:\\+|"+r(a.l,11)+")");c=b.match(c);return null!=c&&null!=c[0]&&0<c[0].length?(a.ca=true,c=c[0].length,E(a.g),a.g.g(b.substring(c)),E(a.h),a.h.g(b.substring(0,c)),"+"!=b.charAt(0)&&a.h.g(" "),true):false}function rb(a){if(0==a.g.h.length)return  false;var b=new D,c=eb(a.g,b);if(0==c)return  false;E(a.g);a.g.g(b.toString());b=S(c);"001"==b?a.l=T(a.ga,""+c):b!=a.ka&&(a.l=jb(a,b));a.h.g(""+c).g(" ");a.o="";return  true}
...
const globalContext = typeof window !== 'undefined' ? window : typeof global !== 'undefined' ? global : typeof self !== 'undefined' ? self : undefined;
