...
const SallaMultipleBundleProductOptionsModal = class {
    ...
    render() {
        ...
        return (h(Host, { key: '80217a97bc81ba7eb770cfa88347530b5cc0850d' }, h("salla-modal", { key: 'f23a97440cdb8418a0f8cf129328fb8c0a0a4fc5', isLoading: this.isLoading, ref: el => (this.modal = el), width: "md", centered: false, id: `s-multiple-bundle-product-options-modal-options-${productId}`, class: "s-multiple-bundle-product-options-modal-wrapper" }, h("div", { key: '06dfaf9708dd142dd0e44b6846cc0ca49be39bb6', slot: "loading" }, h("salla-skeleton", { key: 'a5d348f9a5158ee85d418f30f302a929f0a4dbdd', height: "100%", width: "100%" })), this.product?.images && this.product?.images.length > 0 && (h("salla-slider", { key: 'd3b1a1bb86708a807ee0c3a0168440f9d38b1eb8', id: `details-slider-${this.product?.id}`, type: "thumbs", loop: false, "auto-height": true, "listen-to-thumbnails-option": true, showThumbsControls: false, controlsOuter: false, showControls: false, class: "s-multiple-bundle-product-options-modal-slider", verticalThumbs: true, thumbsConfig: {
                centeredSlides: true,
                ...
                direction: 'vertical',
                spaceBetween: 10,
            } }, h("div", { key: 'b7d04522efcb3f0a85ac78a9bf6f654973f6c777', slot: "items" }, this.product?.images &&
            this.product?.images.map((image, index) => (h("div", { key: index, class: "swiper-slide" }, h("img", { src: image.url, alt: image.alt || `${this.product?.name} - Image ${index + 1}`, loading: "lazy", onError: e => {
                ...
                } }))))), this.product?.images && this.product?.images.length > 1 && (h("div", { key: '3751a38d528780bb5f6ede2eb74365eefd5d42c7', slot: "thumbs" }, this.product?.images &&
            this.product?.images.map((image, index) => (h("div", { key: index, "data-caption": `${this.product?.name} - Image ${index + 1}` }, h("img", { src: image.url, loading: "eager", class: "s-multiple-bundle-product-options-modal-slider-thumb", title: `${this.product?.name} - ${index + 1}`, alt: image.alt || `${this.product?.name} - ${index + 1}`, onError: e => {
                    e.target.style.display = 'none';
                } })))))))), h("salla-product-options", { options: JSON.stringify(optionsWithSelectedState), key: `${cacheKey}-reset-${resetToken}`, "product-id": productId, "unique-key": `${cacheKey}-reset-${resetToken}` }), h("div", { key: '68d6671c68f3753edd92f3c8ea8c91774038da59', slot: "footer" }, h("div", { key: 'f980914dbdbbea3aa02f6c816e2372f7bb09009e', class: "s-multiple-bundle-product-options-modal-footer" }, h("salla-button", { key: '5d67dc612aa88fbc6eb11bcd5be0fc6d77a15aba', onClick: e => this.onSave(e), loading: this.isLoading, disabled: isDisabled }, this.isLoading
...
const SallaMultipleBundleProductSlider = class {
    ...
    render() {
        return (h(Host, { key: '84a2765b8e57fa7d4d757c7e0c8a634199e7f121' }, h("salla-slider", { key: '67d1748a2c19adca4db056bd3b5e5de6813aa367', type: "carousel", controlsOuter: false, showControls: false, id: `accordion-multiple-bundle-product-${this.section.id}`, pagination: true, class: "s-multiple-bundle-product-wrapper-slider", sliderConfig: { spaceBetween: 0 } }, h("div", { key: '04547e4a998d15377a2d5573bd0c4d8d33a93af7', slot: "items" }, this?.section?.products?.map((product, productIndex) => {
            const isChecked = this.selectedProducts[this.section.id]?.has(product.id) || false;
