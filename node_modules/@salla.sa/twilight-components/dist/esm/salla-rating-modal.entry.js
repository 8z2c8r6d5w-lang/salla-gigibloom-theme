...
const SallaRatingModal = class {
    ...
    render() {
        if (this.enableNewPopUp) {
            return (h(Host, { class: "s-rating-modal" }, h("salla-rating-modal-v2", { ref: (el) => (this.v2Ref = el), orderId: this.orderId, productId: this.productId })));
        }
        if (this.deleteMode) {
