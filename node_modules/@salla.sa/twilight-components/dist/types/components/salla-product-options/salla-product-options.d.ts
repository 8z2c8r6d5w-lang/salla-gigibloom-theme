...
export declare class SallaProductOptions {
    ...
    isCartMode: boolean;
    availabilityMap: Record<string | number, 'available' | 'out_of_stock' | 'impossible'>;
    /**
   ...
   */
    ...
    private pruneInvisibleConditionalSelections;
    private clearStaleOption;
    private getLatLng;
     ...
     * */
    seedSelectedOptions(): Promise<void>;
     ...
     * ============= Advanced options =============
     */
    protected getOptionDetailName(detail: Detail, outOfStock?: boolean, optionType?: string, format?: Option['format']): any;
