...
export declare class SallaProductsList {
    ...
    /**
     * Custom event fired when the selection changes (only when `selectable` is enabled).
     ...
     */
    private wrapSelectableItem;
    private toggleSelection;
    private emitSelection;
    private readonly onWishlistItemRemoved;
    private readonly onWishlistStorageSynced;
    private appendProductCards;
    private refreshWishlistIconsAfterHydration;
    /**
     ...
     */
    onSelectableChanged(newValue: boolean, oldValue: boolean): void;
     ...
     */
    private isAuxiliaryProductsListSource;
    private toCategoryIdFilter;
    ...
    private refreshInfiniteScrollMeasurements;
    private applyBeforeBuildListUrl;
    private resolveNextPageFromCursor;
     ...
     */
    getLoadedProducts(): Promise<Product[]>;
    /**
     ...
     * );
     */
    private applyBeforeAppendItems;
}
